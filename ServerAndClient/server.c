...
void setupSignalHandlers() {
    signal(SIGINT, (void *)cleanupSemaphore); 
    signal(SIGTERM, (void *)cleanupSemaphore); 
    signal(SIGSEGV, (void *)cleanupSemaphore);
    signal(SIGHUP, (void *)cleanupSemaphore);  
    signal(SIGQUIT, (void *)cleanupSemaphore);
}
